...
import com.rairmmd.andsqlite.assit.Checker;
import com.rairmmd.andsqlite.assit.CollSpliter;
import com.rairmmd.andsqlite.assit.Querier;
import com.rairmmd.andsqlite.assit.QueryBuilder;
import com.rairmmd.andsqlite.assit.SQLBuilder;
import com.rairmmd.andsqlite.assit.SQLStatement;
import com.rairmmd.andsqlite.assit.SQLiteHelper;
import com.rairmmd.andsqlite.assit.WhereBuilder;
import com.rairmmd.andsqlite.db.DataBase;
import com.rairmmd.andsqlite.db.DataBaseConfig;
import com.rairmmd.andsqlite.db.TableManager;
import com.rairmmd.andsqlite.impl.CascadeSQLiteImpl;
import com.rairmmd.andsqlite.impl.SingleSQLiteImpl;
import com.rairmmd.andsqlite.model.ColumnsValue;
import com.rairmmd.andsqlite.model.ConflictAlgorithm;
import com.rairmmd.andsqlite.model.EntityTable;
import com.rairmmd.andsqlite.model.MapProperty;
import com.rairmmd.andsqlite.model.RelationKey;
import com.rairmmd.andsqlite.utils.ClassUtil;
import com.rairmmd.andsqlite.utils.DataUtil;
import com.rairmmd.andsqlite.utils.FieldUtil;
import com.rairmmd.andsqlite.utils.OrmLog;
 ...
 */
public abstract class AndSQLite extends SQLiteClosable implements DataBase {

    public static final String TAG = AndSQLite.class.getSimpleName();
    ...
    protected AndSQLite otherDatabase;

    protected AndSQLite(AndSQLite dataBase) {
    ...
    protected AndSQLite(DataBaseConfig config) {
     ...
     */
    public static AndSQLite newSingleInstance(Context context, String dbName) {
     ...
     */
    public synchronized static AndSQLite newSingleInstance(DataBaseConfig config) {
     ...
     * @return {@link SingleSQLiteImpl}
     */
    public static AndSQLite newCascadeInstance(Context context, String dbName) {
     ...
     * @return {@link CascadeSQLiteImpl}
     */
    public synchronized static AndSQLite newCascadeInstance(DataBaseConfig config) {
     ...
     *
     * @return {@link com.rairmmd.andsqlite.impl.CascadeSQLiteImpl}
     */
    public abstract AndSQLite single();
     ...
     * @return {@link com.rairmmd.andsqlite.impl.CascadeSQLiteImpl}
     */
    public abstract AndSQLite cascade();
