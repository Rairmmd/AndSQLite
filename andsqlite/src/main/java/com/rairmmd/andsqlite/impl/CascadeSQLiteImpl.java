package com.rairmmd.andsqlite.impl;

import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;

import com.rairmmd.andsqlite.AndSQLite;
...
import com.rairmmd.andsqlite.assit.Transaction;
...
import com.rairmmd.andsqlite.model.Property;
 ...
 * @date 2015-03-13
 */
public final class CascadeSQLiteImpl extends AndSQLite {

    public static final String TAG = CascadeSQLiteImpl.class.getSimpleName();

    protected CascadeSQLiteImpl(AndSQLite dataBase) {
        super(dataBase);
    }
    ...
    public synchronized static AndSQLite newInstance(DataBaseConfig config) {
        return new CascadeSQLiteImpl(config);
    }

    @Override
    public AndSQLite single() {
